...
/*
*   Angepasste Version der originalen MPU6050 Treiber von Espressif.
*   Änderungen: 
*   - "driver/i2c_master.h" wird anstelle der älteren Version "driver/i2c.h" eingebunden
*/
...
static esp_err_t mpu6050_write(mpu6050_handle_t sensor, const uint8_t reg_start_addr, const uint8_t *const data_buf, const uint8_t data_len)
{
    ...
    return i2c_master_transmit(sens->i2c_dev, write_buf, sizeof(write_buf), 1000);
}
...
mpu6050_handle_t mpu6050_create(i2c_master_dev_handle_t i2c_dev, const uint16_t dev_addr)
{
